...
function Object_InnerInit(imp, obj, init_type)
	...
	if(init_type == 0 or init_type == 1) then
		...
		obj.GetCultAttack       = __ABASE_OBJECT_GetCultAttack
                obj.GetCultDefense      = __ABASE_OBJECT_GetCultDefense
                obj.GetDmgReduce        = __ABASE_OBJECT_GetDmgReduce
	end
	...
	if(init_type == 0 or init_type == 2) then
		...
		obj.SetCultAttack       = __ABASE_OBJECT_SetCultAttack
                obj.SetCultDefense      = __ABASE_OBJECT_SetCultDefense
                obj.SetDmgReduce        = __ABASE_OBJECT_SetDmgReduce
	end
