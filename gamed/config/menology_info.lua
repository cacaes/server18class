...
MenologyRecommend['天下会武'] = 
			{ 
				...
				commendlevel=3, istasknpc=false, descnpc="紫微道光元帅", descmapid=-1, descpos="535,476,405", istransport=false, 
...
MenologyRecommend['天行者'] = 
			{ 
				...
				commendlevel=3, istasknpc=false, descnpc="天行者", descmapid=401, descpos="437,526,607", istransport=true, 
...
MenologyRecommend['景仰先贤'] = 
			{ 
				...
				commendlevel=3, istasknpc=false, descnpc="沈墨儒", descmapid=401, descpos="418,487,386", istransport=true, 
...
MenologyRecommend['建功立事'] = 
			{ 
				...
				commendlevel=3, istasknpc=false, descnpc="帮会管理员", descmapid=401, descpos="428,485,264", istransport=true, 
...
MenologyRecommend['宝物'] = 
			{ 
				...
				commendlevel=3, istasknpc=false, descnpc="吴民财", descmapid=401, descpos="402,487,366", istransport=true, 
...
MenologyBattleField['楚汉军魂'] 	= 
			{ 
				...
				desc="^FFCB4A       九里山垓下古战场，你是辅佐汉王刘邦，一匡天下，开创百年基业，还是救援楚王项羽，力挽狂澜，成就世间霸王？问鼎乾坤，等待你的抉择……（要求飞升角色）"
			}
...
---				desc="^FFCB4A       演武大阵，数名高手共同竞技，不仅需要有以一敌百的实力，更考验在危机中的生存能力，最终决出唯一的胜利者，体验唯我独尊的畅快与喜悦。（要求未飞升角色）"
---			}
...
---				},
---				commendlevel=3, istasknpc=false, descnpc="", descmapid=401, descpos="170,0,176", istransport=true, 
---				desc="^FFCB4A       演武大阵，数名高手共同竞技，不仅需要有以一敌百的实力，更考验在危机中的生存能力，最终决出唯一的胜利者，体验唯我独尊的畅快与喜悦。（要求飞升角色）"
---			}
MenologyBattleField['炎狱'] = 
			{ 
				...
				desc="^FFCB4A       隐仙阁与逸龙轩两派，定期举行天下会武之地，此地烈火熊熊，进入则身受热浪蒸腾之苦，在其中历练可大幅度提升自身修为。（要求未飞升角色）"
			}
MenologyBattleField['武围'] = 
			{ 
				...
				commendlevel=3, istasknpc=false, descnpc="", descmapid=401, descpos="519,493,344", istransport=true, 
				desc="^FFCB4A       隐仙阁与逸龙轩两派，定期举行天下会武之地，此处机关遍地，危机重重，在其中历练可大幅度提升自身修为。（要求未飞升角色）"
			}
MenologyBattleField['界河'] = 
			{ 
				...
				commendlevel=3, istasknpc=false, descnpc="", descmapid=401, descpos="519,493,344", istransport=true, 
				desc="^FFCB4A       隐仙阁与逸龙轩两派，定期举行天下会武之地，双方以河为界，斗智斗勇，在其中历练可大幅度提升自身修为。（要求未飞升角色）"
			}
MenologyBattleField['天弈'] = 
			{ 
				...
				commendlevel=3, istasknpc=false, descnpc="", descmapid=401, descpos="519,493,344", istransport=true, 
				desc="^FFCB4A       隐仙阁与逸龙轩两派，定期举行天下会武之地，内呈棋盘之势，步步惊心，在其中历练可大幅度提升自身修为。（要求未飞升角色）"
			}
MenologyBattleField['幻世炎狱'] = 
			{ 
				...
				commendlevel=3, istasknpc=false, descnpc="", descmapid=401, descpos="519,493,344", istransport=true, 
				desc="^FFCB4A       隐仙阁与逸龙轩两派，定期举行天下会武之地，此地烈火熊熊，进入则身受热浪蒸腾之苦，在其中历练可大幅度提升自身修为。（要求飞升角色）"
			}
MenologyBattleField['幻世武围'] = 
			{ 
				...
				commendlevel=3, istasknpc=false, descnpc="", descmapid=401, descpos="519,493,344", istransport=true, 
				desc="^FFCB4A       隐仙阁与逸龙轩两派，定期举行天下会武之地，此处机关遍地，危机重重，在其中历练可大幅度提升自身修为。（要求飞升角色）"
			}
MenologyBattleField['幻世界河'] = 
			{ 
				...
				commendlevel=3, istasknpc=false, descnpc="", descmapid=401, descpos="519,493,344", istransport=true, 
				desc="^FFCB4A       隐仙阁与逸龙轩两派，定期举行天下会武之地，双方以河为界，斗智斗勇，在其中历练可大幅度提升自身修为。（要求飞升角色）"
			}
MenologyBattleField['幻世天弈'] = 
			{  
				...
				commendlevel=3, istasknpc=false, descnpc="", descmapid=401, descpos="519,493,344", istransport=true, 
				desc="^FFCB4A       隐仙阁与逸龙轩两派，定期举行天下会武之地，内呈棋盘之势，步步惊心，在其中历练可大幅度提升自身修为。（要求飞升角色）"
			}
MenologyBattleField['草庙村'] = 
			{ 
				...
				desc="^FFCB4A       宁静的草庙村风云诡谲，所有的传说都将从这里开始。你回到梦开始的地方，重拾曾经的感动，一切一切须在此开始，也终须在此了结。"
			}
MenologyBattleField['真武剑阁'] = 
			{ 
				...
				commendlevel=3, istasknpc=false, descnpc="", descmapid=401, descpos="491,493,330", istransport=true, 
				desc="^FFCB4A       真武大帝藏剑的宫殿，相传遗留下诸多的真武心解，更有诸多上古神兵遗留于此，是三界修士历练寻珍的不二宝地。"
			}
MenologyBattleField['天帝宝库'] = 
			{ 
				...
				award=
				{
					...
					{awardid=34029, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a大量经验"},
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
				},
				commendlevel=3, istasknpc=false, descnpc="", descmapid=401, descpos="491,493,330", istransport=true, 
				desc="^FFCB4A       天帝宝库藏有太初神物，但其间禁制重重，稍有不慎便万劫难复。如今又到了神物出世时节，谁人能够获得太初神宝，谁又是宝库的应缘之人?（要求飞升角色）"
			}
MenologyBattleField['幻月洞府'] = 
			{ 
				...
				commendlevel=3, istasknpc=false, descnpc="", descmapid=401, descpos="491,493,330", istransport=true, 
				desc="^FFCB4A       幻月洞府乃青云门禁地，为重振青云威望，门中弟子陆雪琪勇闯幻月洞府，谁能协她一臂之力？（需级别为20级以上的家族成员）"
			}
MenologyBattleField['鸿蒙试炼'] = 
			{ 
				...
				desc="^FFCB4A       鸿蒙之地，神秘难测，内有各种珍奇异宝，也有无数恶灵宵小，带上你的队友，挑战一下自己的实力吧！（需级别为120级以上飞升角色，建议4人以上）"
			}
MenologyBattleField['焚香谷副本'] = 
			{ 
				...
				rewardtype=0, maskinfo=0, name="焚香谷副本" , ismendisplay=false, mendisplaylevel=124, 
				...
				desc="^FFCB4A       隐匿数年的焚香、太昊重现世间，一时之间流言纷纷。传说谁能破解八荒玄火阵之谜，谁就能称霸世间！修真者们聚集起来：前往焚香谷的中心玄火坛，寻找八荒玄火阵！（需级别为120级以上角色，建议10人以上）"
			}
MenologyBattleField['梦境河阳城'] = 
			{ 
				...
				desc="^FFCB4A       梦境河阳城乃平行现今世界的另一个时空之物，通过诛仙古卷可前往探索。完成其居民心愿可获得大量奖励。（需要级别为30级以上角色，建议3人以上）"
			}
MenologyBattleField['神武镇元塔'] = 
			{ 
				id=220, tmplid=543, iconpath1="忠烈碑.dds", iconpath2="忠烈碑大.dds", iconpath3="icon\\Menology_huiwu.tga", 
				rewardtype=0, maskinfo=0, name="神武镇元塔" , ismendisplay=false, mendisplaylevel=121, 
				validtime="0:00-24:00", levelreq="30-160", needreborn=false, permitcount=1, cond="", 
				...
				desc="^FFCB4A       在《神魔异志录》中，记载一方神秘之塔，据载为督天元帅以无边大法力设建，被当时修真者尊奉为“圣塔”。此塔巍峨耸入云天，全然不见塔顶。凡进入其中之辈，皆有通天彻地之能的无量神通。如此圣塔，在经历上古魔神之战后，却逸形无踪。\r由是向后数千年，世间修真者在苦苦搜寻无果后颓然罢手，并将圣塔笑为无稽的传说。然而如今三官大帝尊临河阳，撤除了上古圣塔的封禁，并名之为神武天极塔，再次在世间的修真者面前显露真容，这是天神对凡世的又一次考验，不知通过者能有几许。。。"
			}
MenologyBattleField['凌霄城副本'] = 
			{ 
				...
				desc="^FFCB4A       凌霄城浮于九天之上，闲杂世人不能贸然进入。城中更有诛仙剑之元鉴镇守，贸然进入者将受到五雷亟体之苦。如今戾气肆虐神州，天帝洞开凌霄城门，谕令但凡能够战胜诛仙元鉴者，将赐予无上法宝。"
			}
MenologyBattleField['河阳剧变'] = 
			{ 
				...
				validday="1,2,3,4,5,6,7", displayday="每天", line="1-15线", npc="阿妤", istaskaward=false, taskid="1",
				award=
				{
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
					{awardid=21345, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a大量经验"},
					{awardid=53801, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a大量经验"},
					{awardid=53803, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a大量经验"},
					{awardid=62396, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a大量经验"},
				},
				commendlevel=3, istasknpc=false, descnpc="", descmapid=401, descpos="487,490,289", istransport=true, 
				desc="^FFCB4A       邪魔当道，天怒人怨。无数诡谲的异变，使得昔日的河阳城俨然成为人间炼狱。怨晶盘生、炙魔横行、白骨盈野、破碎虚空，种种凶兆恰似向世间正道的挑战。此时，各种族与门派精英齐聚河阳城，欲在三位灵魂人物的带领下，救治河阳大地的创伤，你准备好了吗？"
			}
MenologyBattleField['剿杀！兽神之叹息'] = 
			{ 
				...
				validday="1,2,3,4,5,6,7", displayday="每天", line="1-15线", npc="南疆特派使者", istaskaward=false, taskid="1",
				award=
				{
					{awardid=65833, awardiconpath="衣服类.dds", awarddesc="^ffcb4a四圣之书\r^ffffff用于天书界面之中，提升自身实力"},
					{awardid=65931, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a大量经验"},
					{awardid=65937, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a大量经验"},
					{awardid=65943, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a大量经验"},
					{awardid=66739, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a大量经验"},
				},
				commendlevel=3, istasknpc=false, descnpc="", descmapid=401, descpos="492,490,293", istransport=true, 
				desc="^FFCB4A       兽神自青云山一战，在千年妖狐小白的协助下败归茫茫十万大山，但其藏身之地已然暴露，无数修真之士紧随而至，欲将其一举诛杀。静卧千万年的十万大山自此喧嚣不止，是除妖卫道，以证世间正义，还是慕名于传说中的巫族宝藏和秘术，一切尽在你的选择。\r正所谓，山不解情人解情，万般纠葛起玲珑。枉自逆天破大道，留得后世陷纷争。"
			}
MenologyBattleField['天官赐福（财神）'] = 
			{ 
				id=224, tmplid=789, iconpath1="财神副本.dds", iconpath2="财神副本大.dds", iconpath3="icon\\Menology_huiwu.tga", 
				rewardtype=0, maskinfo=0, name="天官赐福（财神）" , ismendisplay=false, mendisplaylevel=125, 
				validtime="0:00-24:00", levelreq="90-160", needreborn=true, permitcount=3, cond="", 
				validday="1,2,3,4,5,6,7", displayday="每天", line="1-15线", npc="巡游人间的仙官", istaskaward=false, taskid="1",
				award=
				{
					{awardid=58665, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a大量经验"},
					{awardid=58663, awardiconpath="衣服类.dds", awarddesc="^ffcb4a飞升系列装备\r^ffffff适合等级：飞升140级"},
					...
					{awardid=56030, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a大量经验"},
				},
...
MenologyBattleField['天官赐福（童子）'] = 
			{ 
				...
				validtime="0:00-24:00", levelreq="90-160", needreborn=true, permitcount=3, cond="", 
				validday="1,2,3,4,5,6,7", displayday="每天", line="1-15线", npc="金童", istaskaward=false, taskid="1",
				award=
				{
					{awardid=58663, awardiconpath="衣服类.dds", awarddesc="^ffcb4a飞升系列装备\r^ffffff适合等级：飞升140级"},
					{awardid=58664, awardiconpath="衣服类.dds", awarddesc="^ffcb4a升级模具\r^ffffff升级装备的必备道具。"},
...
MenologyBattleField['十神宝窟（150-155）'] = 
			{ 
				id=226, tmplid=837, iconpath1="十神宝窟副本1.dds", iconpath2="十神宝窟副本1大.dds", iconpath3="icon\\Menology_huiwu.tga", 
				rewardtype=0, maskinfo=0, name="十神宝窟（150-155）" , ismendisplay=false, mendisplaylevel=127, 
				validtime="0:00-24:00", levelreq="150-155", needreborn=true, permitcount=1, cond="", 
				validday="1,2,3,4,5,6,7", displayday="每天", line="1-15线", npc="问道灵君", istaskaward=false, taskid="1",
				award=
				{
...
MenologyBattleField['十神宝窟（156-160）'] = 
			{ 
				id=227, tmplid=838, iconpath1="十神宝窟副本2.dds", iconpath2="十神宝窟副本2大.dds", iconpath3="icon\\Menology_huiwu.tga", 
				rewardtype=0, maskinfo=0, name="十神宝窟（156-160）" , ismendisplay=false, mendisplaylevel=128, 
...
MenologyBattleField['四象宫'] = 
			{ 
				id=228, tmplid=690, iconpath1="四象宫副本.dds", iconpath2="四象宫副本大.dds", iconpath3="icon\\Menology_huiwu.tga", 
				rewardtype=0, maskinfo=0, name="四象宫" , ismendisplay=false, mendisplaylevel=126, 
				validtime="0:00-24:00", levelreq="120-160", needreborn=true, permitcount=1, cond="", 
				validday="1,2,3,4,5,6,7", displayday="每天", line="1-15线", npc="四象真人", istaskaward=false, taskid="1",
				award=
				{
...
MenologyBattleField['神武天极塔'] = 
			{ 
				id=229, tmplid=1093, iconpath1="演武阵.dds", iconpath2="演武阵大.dds", iconpath3="icon\\Menology_huiwu.tga", 
				rewardtype=0, maskinfo=0, name="神武天极塔" , ismendisplay=false, mendisplaylevel=121, 
				validtime="0:00-24:00", levelreq="30-160", needreborn=false, permitcount=3, cond="", 
				validday="1,2,3,4,5,6,7", displayday="每天", line="1-15线", npc="三官大帝", istaskaward=false, taskid="1",
				award=
				{
				...
				commendlevel=3, istasknpc=false, descnpc="", descmapid=401, descpos="476,490,300", istransport=true, 
				desc="^FFCB4A       在《神魔异志录》残页中，记载一方更为神秘的天极之塔，疑同为督天元帅以无边大法力设建，但其气势之雄伟、考验之凶险却是神武镇元塔无从比拟。原本匿形于浩瀚烟云的此塔，终于在天地动荡之际再现世间，为三官大帝所发现，并将其呈现到修真者的面前。\r此塔虽载物于无穷，却凶险万分，实难由一人之力所胜任，需结伴前往，方可不虚此行。"
			}
MenologyBattleField['灵族秘库'] = 
			{ 
				...
				validday="1,2,3,4,5,6,7", displayday="每天", line="1-15线", npc="霖琪", istaskaward=false, taskid="1",
				award=
				{
...
MenologyBattleField['秘藏！青女的谜歌'] = 
			{ 
				id=231, tmplid=1319, iconpath1="秘藏青女的谜歌.dds", iconpath2="秘藏青女的谜歌大.dds", iconpath3="icon\\Menology_huiwu.tga", 
				rewardtype=0, maskinfo=0, name="秘藏！青女的谜歌" , ismendisplay=false, mendisplaylevel=127, 
				validtime="0:00-24:00", levelreq="155-160", needreborn=true, permitcount=1, cond="", 
				validday="1,2,3,4,5,6,7", displayday="每天", line="1-15线", npc="大荒圣母", istaskaward=false, taskid="1",
				award=
				{
...
MenologyDailyMissionOne['每日一卦'] =
      { 
	        ...
	        {awardid=0, awardiconpath="特殊物品奖励.dds", awarddesc="^ffcb4a活跃度积分\r^ffffff获得该项活跃度积分。"},
				...
				commendlevel=3, istasknpc=false, descnpc="周一仙", descmapid=401, descpos="448,487,522", istransport=true, 
...
MenologyDailyMissionOne['聚妖令'] =
      { 
				...
				commendlevel=3, istasknpc=false, descnpc="何隆尧", descmapid=401, descpos="459,486,310", istransport=true, 
...
MenologyDailyMissionOne['行天'] =
      { 
				...
				commendlevel=3, istasknpc=false, descnpc="天行者", descmapid=401, descpos="449,527,615", istransport=true, 
				desc="^ffffff       每天在完成《天行者》任务后，可以在天行者处领取后续高经验奖励任务任务^ffcb4a“行天”^ffffff。\r       完成任务可以获得^ffcb4a100个太极金丹^ffffff的经验奖励。"
			}			
MenologyDailyMissionOne['诛仙古卷（相生）'] =
      { 
				id=600, iconpath1="诛仙古卷（相生）.dds", iconpath2="诛仙古卷（相生）大.dds",name="诛仙古卷（相生）",
				validtime="0:00-24:00", levelreq="30-160", needreborn=false, permitcount=1, 
				...
				commendlevel=3, istasknpc=false, descnpc="诛仙古卷", descmapid=401, descpos="415,587,426", istransport=true, 
				desc="^ffffff       在河阳城^ffcb4a诛仙古卷^ffffff处领取任务^ffcb4a“诛仙古卷（相生）”^ffffff。\r       完成任务可以获得大量奖励。"
			}
MenologyDailyMissionOne['破凶咒'] =
      { 
				id=601, iconpath1="新破凶咒.dds", iconpath2="新破凶咒大.dds",name="破凶咒",
				validtime="0:00-24:00", levelreq="30-160", needreborn=false, permitcount=1, 
				line="1-15线", npc="传功使者", istaskaward=false, taskid="1",
				award=
				{
				  {awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
				...
				commendlevel=3, istasknpc=false, descnpc="传功使者", descmapid=401, descpos="360,486,428", istransport=true, 
				desc="^ffffff       在河阳城^ffcb4a传功使者^ffffff处领取任务^ffcb4a“破凶咒”^ffffff。\r       完成任务可以获得大量奖励。"
			}
MenologyDailyMissionOne['刁蛮公主'] =
      { 
				id=602, iconpath1="刁蛮公主.dds", iconpath2="刁蛮公主大.dds",name="刁蛮公主",
				validtime="0:00-24:00", levelreq="135-160", needreborn=true, permitcount=1, 
				line="1-15线", npc="日月龙王", istaskaward=false, taskid="1",
				award=
				{
				  {awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
				...
				commendlevel=3, istasknpc=false, descnpc="日月龙王", descmapid=44, descpos="219,276,457", istransport=true, 
				desc="^ffffff       在中州万流城的^ffcb4a日月龙王^ffffff处领取一块^ffcb4a龙族星盘^ffffff。右键点击使用可以根据星盘的提示寻找龙族公主。\r       完成任务可以获得大量奖励。"
			}
...
MenologyDailyActivity['小虎回家'] =
      { 
				id=515, iconpath1="白色情人节.dds", iconpath2="白色情人节大.dds",name="小虎回家",
				validtime="0:00-24:00", levelreq="60-160", needreborn=false, permitcount=1, 
				line="15线", npc="庙会传送门", istaskaward=false, taskid="19641",
				award=
				{
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。\r个数：60"},
				...
				commendlevel=3, istasknpc=false, descnpc="庙会传送门", descmapid=401, descpos="409,478,635", istransport=true, 
...
MenologyDailyActivity['点石成金'] =
      { 
				id=517, iconpath1="财神副本.dds", iconpath2="财神副本大.dds",name="点石成金",
				validtime="0:00-24:00", levelreq="60-160", needreborn=false, permitcount=1, 
				line="15线", npc="庙会传送门", istaskaward=false, taskid="19651",
				award=
				{
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。\r个数：60"},
...
MenologyDailyActivity['走失的灵兽'] =
      { 
				...
				validtime="0:00-24:00", levelreq="80-160", needreborn=false, permitcount=1, 
				line="15线", npc="庙会传送门", istaskaward=false, taskid="24377",
				award=
				{
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。\r个数：60"},
...
MenologyDailyActivity['摸鱼儿'] =
      { 
				id=610, iconpath1="钓鱼大赛.dds", iconpath2="钓鱼大赛大.dds",name="摸鱼儿",
				validtime="0:00-24:00", levelreq="60-160", needreborn=false, permitcount=1, 
				line="15线", npc="庙会传送门", istaskaward=false, taskid="24377",
				award=
				{
				...
				commendlevel=3, istasknpc=false, descnpc="庙会传送门", descmapid=401, descpos="409,478,635", istransport=true, 
				desc="^ffffff       协助庙会里的^ffcb4a钓叟^ffffff钓鱼，快去^ffcb4a15线庙会^ffffff寻找他吧。\r 完成任务即可获得大量奖励。"
			}
MenologyDailyActivity['饲养神兽'] =
      { 
				id=611, iconpath1="饲养神兽.dds", iconpath2="饲养神兽大.dds",name="饲养神兽",
				validtime="0:00-24:00", levelreq="60-160", needreborn=false, permitcount=1, 
				line="15线", npc="庙会传送门", istaskaward=false, taskid="24377",
				award=
				{
				...
				commendlevel=3, istasknpc=false, descnpc="庙会传送门", descmapid=401, descpos="409,478,635", istransport=true, 
				desc="^ffffff       协助庙会里^ffcb4a百兽之主^ffffff交给你的神兽饲养长大，快去^ffcb4a15线庙会^ffffff寻找他吧。\r 完成任务即可获得大量奖励。"
			}
...
MenologyDailyBattle['帝子围栏'] = 
			{ 
				id=620, iconpath1="LOL无差别战场.dds", iconpath2="LOL无差别战场大.dds", name="帝子围栏" ,  
				validtime="分段开启", levelreq="120-160", needreborn=false, permitcount=-1, 
				line="1-15线", npc="帝子围栏", istaskaward=false, taskid="1",
				award=
				{
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a大量经验"},
				...
				commendlevel=3, istasknpc=false, descnpc="帝子围栏", descmapid=-1, descpos="9999,0,9999", istransport=false, 
				desc="^ffffff       无垢明王为蛇妖腐化，重现善见城，龙音、狮牙两派的争端由佛法烧至战场，护卫无垢明王，摧毁外道防线，捍卫你自己的信仰！（每日12:00-14:00，18:00-21:00两个时段开启。）"
			}
MenologyDailyBattle['原服帮战'] = 
			{ 
				id=621, iconpath1="原服帮战.dds", iconpath2="原服帮战大.dds", name="原服帮战" ,  
				validtime="0:00-24:00", levelreq="1-160", needreborn=false, permitcount=-1, 
				line="1-15线", npc="帮战接引使", istaskaward=false, taskid="1",
				award=
				{
				...
				desc="^ffffff       帮派等级大于等于2级的帮派可以报名，双方帮派成员均可参战，其他玩家可以报名进入观战。"
			}
MenologyDailyBattle['跨服帮战'] = 
			{ 
				id=622, iconpath1="跨服帮战.dds", iconpath2="跨服帮战大.dds", name="跨服帮战" ,  
				validtime="12:00-22:00", levelreq="1-160", needreborn=false, permitcount=-1, 
				line="1-15线", npc="帮战接引使", istaskaward=false, taskid="1",
				award=
				{
					{awardid=0, awardiconpath="特殊物品奖励.dds", awarddesc="^ffcb4a大量金钱"},
				...
				commendlevel=3, istasknpc=false, descnpc="帮战接引使", descmapid=401, descpos="428,485,264", istransport=true, 
				desc="^ffffff       各区各服帮派活跃度排行榜上前20名的帮派才可以报名，双方帮派成员均可参战，其他玩家可以报名进入观战。"
			}
MenologyDailyBattle['天界演武'] = 
			{ 
				...
				line="1-15线", npc="斗转星移天王", istaskaward=false, taskid="1",
				award=
				{
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a大量经验"},
...
MenologyDailyBattle['七脉会武'] = 
			{ 
				id=624, iconpath1="七脉会武.dds", iconpath2="七脉会武大.dds", name="七脉会武" ,  
				validtime="20:00-21:00", levelreq="135-160", needreborn=true, permitcount=1, 
				line="1-15线", npc="百里诺兰", istaskaward=false, taskid="1",
				award=
				{
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a大量经验"},
				...
				commendlevel=3, istasknpc=false, descnpc="七脉会武传送使 百里诺兰", descmapid=401, descpos="527,481,409", istransport=true, 
				desc="^ffffff       河阳的^ffcb4a七脉会武传送使 百里诺兰^ffffff将指引你到达七脉会场——青云之巅，病前往^ffcb4a萧逸才^ffffff处俩接七脉会武。玩家可以自由选择代表青云七脉中的任一脉出战。战场赛程分初赛和决赛两部分。"
			}
MenologyDailyBattle['铁血旗魂'] = 
			{ 
				id=625, iconpath1="八极战魂.dds", iconpath2="八极战魂大.dds", name="铁血旗魂" ,  
				validtime="18:00-22:00", levelreq="155-160", needreborn=true, permitcount=3, 
				line="1-15线", npc="广目天君 高嵩业", istaskaward=false, taskid="1",
				award=
				{
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a大量经验"},
...
MenologyDailyDuplicate['家族试炼'] = 
			{ 
				...
				line="1-15线", npc="家族试炼", istaskaward=false, taskid="1",
				award=
				{
					{awardid=21345, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a大量经验"},
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
...
MenologyDailyDuplicate['梦境河阳城'] = 
			{ 
				...
				line="1-15线", npc="梦境河阳城", istaskaward=false, taskid="1",
				award=
				{
					{awardid=52238, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a大量经验"},
					{awardid=0, awardiconpath="特殊物品奖励.dds", awarddesc="^ffcb4a活跃度积分\r^ffffff获得该项活跃度积分。"},
...
MenologyDailyDuplicate['神武镇元塔'] = 
        ...
        line="1-15线", npc="三官大帝", istaskaward=false, taskid="1",
				...
				commendlevel=3, istasknpc=false, descnpc="三官大帝", descmapid=401, descpos="561,476,398", istransport=true, 
...
MenologyDailyDuplicate['焚香谷副本'] = 
			{ 
				...
				name="焚香谷副本" ,validtime="0:00-24:00", levelreq="120-160", needreborn=false, permitcount=1, 
				line="1-15线", npc="焚香谷副本", istaskaward=false, taskid="1",
				award=
				{
					{awardid=21345, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a大量经验"},
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
...
MenologyDailyDuplicate['鸿蒙试炼'] = 
			{ 
				...
				line="1-15线", npc="鸿蒙试炼", istaskaward=false, taskid="1",
				award=
				{
					{awardid=21345, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a大量经验"},
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
...
MenologyDailyDuplicate['四象宫副本'] = 
			{ 
				...
				line="1-15线", npc="四象宫副本", istaskaward=false, taskid="1",
				award=
				{
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
					{awardid=41668, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
...
MenologyDailyDuplicate['十神宝窟副本一'] = 
			{ 
				...
				line="1-15线", npc="十神宝窟副本一", istaskaward=false, taskid="1",
				award=
				{
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
					{awardid=41668, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
...
MenologyDailyDuplicate['十神宝窟副本二'] = 
			{ 
				...
				line="1-15线", npc="十神宝窟副本二", istaskaward=false, taskid="1",
				award=
				{
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
					{awardid=41668, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
...
MenologyDailyDuplicate['圣莲赐福'] = 
			{ 
				id=630, iconpath1="圣莲赐福.dds", iconpath2="圣莲赐福大.dds",
				name="圣莲赐福" , validtime="0:00-24:00", levelreq="60-160", needreborn=false, permitcount=1, 
				line="1-15线", npc="圣莲赐福", istaskaward=false, taskid="1",
				award=
				{
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
				...
				desc="^ffffff       莲花有四德，一香、二净、三柔软、四可爱。\r圣莲为莲中圣品，千年 得花骨，万年方盛开。相传，得圣莲赐福者，可获无量修为，修真之路平步青云。\r如今圣莲即将绽放，灵气冲天，引得各路妖兽 蠢蠢欲动，意图抢得圣莲，为祸人间。\r善良的修真者，若能护莲之圣洁，圣莲必有厚报。"
			}
MenologyDailyDuplicate['云渺天河'] = 
			{ 
				id=631, iconpath1="云渺天河.dds", iconpath2="云渺天河大.dds",
				name="云渺天河" , validtime="12:00-22:00", levelreq="150-160", needreborn=true, permitcount=3, 
				line="1-15线", npc="云渺天河", istaskaward=false, taskid="1",
				award=
				{
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
				...
				commendlevel=3, istasknpc=false, descnpc="云渺天河", descmapid=-1, descpos="9999,0,9999", istransport=false, 
				desc="^ffffff       云渺天河，位于天上界，来自不同区服的仙友可组成多人团队前往探索，共战镜花水月空五大boss，获取全新天命装备和风云印。"
			}
MenologyDailyDuplicate['草庙村'] = 
			{ 
				id=632, iconpath1="草庙村.dds", iconpath2="草庙村大.dds",
				name="草庙村" , validtime="0:00-24:00", levelreq="30-89", needreborn=false, permitcount=1, 
				line="1-15线", npc="草庙村", istaskaward=false, taskid="1",
				award=
				{
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
...
MenologyDailyDuplicate['神武天极塔'] = 
			{ 
				id=633, iconpath1="神武天极塔.dds", iconpath2="神武天极塔大.dds",
				name="神武天极塔" , validtime="0:00-24:00", levelreq="30-160", needreborn=false, permitcount=3, 
				line="1-15线", npc="神武天极塔", istaskaward=false, taskid="1",
				award=
				{
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
				...
				commendlevel=3, istasknpc=false, descnpc="神武天极塔", descmapid=-1, descpos="9999,0,9999", istransport=false, 
				desc="^ffffff       在《神魔异志录》残页中，记载一方更为神秘的天极之塔，疑同为督天元帅以无边大法力设建，但其气势之雄伟、考验之凶险却是神武镇元塔无从比拟。原本匿形于浩瀚烟云的此塔，终于在天地动荡之际再现世间，为三官大帝所发现，并将其呈现到修真者的面前。\r此塔虽载物于无穷，却凶险万分，实难由一人之力所胜任，需结伴前往，方可不虚此行。"
			}
MenologyDailyDuplicate['真武剑阁'] = 
			{ 
				id=634, iconpath1="真武剑阁.dds", iconpath2="真武剑阁大.dds",
				name="真武剑阁" , validtime="0:00-24:00", levelreq="90-119", needreborn=false, permitcount=1, 
				line="1-15线", npc="真武剑阁", istaskaward=false, taskid="1",
				award=
				{
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
				...
				commendlevel=3, istasknpc=false, descnpc="真武剑阁", descmapid=-1, descpos="9999,0,9999", istransport=false, 
				desc="^ffffff       真武大帝藏剑的宫殿，相传遗留下诸多的真武心解，更有诸多上古神兵遗留于此，是三界修士历练寻珍的不二宝地。"
			}
MenologyDailyDuplicate['天官赐福（财神）'] = 
			{ 
				id=635, iconpath1="天官赐福（财神）.dds", iconpath2="天官赐福（财神）大.dds",
				name="天官赐福（财神）" , validtime="0:00-24:00", levelreq="90-160", needreborn=true, permitcount=3, 
				line="1-15线", npc="天官赐福（财神）", istaskaward=false, taskid="1",
				award=
				{
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
...
MenologyDailyDuplicate['天官赐福（童子）'] = 
			{ 
				...
				name="天官赐福（童子）" , validtime="0:00-24:00", levelreq="90-160", needreborn=true, permitcount=3, 
				line="1-15线", npc="天官赐福（童子）", istaskaward=false, taskid="1",
				award=
				{
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
					{awardid=58663, awardiconpath="衣服类.dds", awarddesc="^ffcb4a震系列装备\r^ffffff适合等级：飞升140级"}, 
...
MenologyDailyDuplicate['剿杀！兽神之叹息'] = 
			{ 
				id=637, iconpath1="兽神之叹息.dds", iconpath2="兽神之叹息大.dds",
				name="剿杀！兽神之叹息" , validtime="0:00-24:00", levelreq="150-160", needreborn=true, permitcount=1, 
				line="1-15线", npc="剿杀！兽神之叹息", istaskaward=false, taskid="1",
				award=
				{
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
...
MenologyDailyDuplicate['秘藏！青女的谜歌'] = 
			{ 
				id=638, iconpath1="青女的迷歌.dds", iconpath2="青女的迷歌大.dds",
				name="秘藏！青女的谜歌" , validtime="0:00-24:00", levelreq="155-160", needreborn=true, permitcount=1, 
				line="1-15线", npc="秘藏！青女的谜歌", istaskaward=false, taskid="1",
				award=
				{
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
					{awardid=65937, awardiconpath="衣服类.dds", awarddesc="^ffcb4a震系列装备\r^ffffff适合等级：飞升140级"}, 
				...
				commendlevel=3, istasknpc=false, descnpc="秘藏！青女的谜歌", descmapid=-1, descpos="9999,0,9999", istransport=false, 
				desc="^ffffff       西海之外，大荒之隅，有寒山覆雪成冰，终年不化，名曰西岭。\r    光阴混沌，数万载辗转而过，修真者的脚步轰然叩响世界尽头的大门，声震九霄，达于大荒，在冰雪中沉睡的传奇次第苏醒，誓要将号角吹响，传彻大地的每个角落。\r    最纯净的冰天雪地，最诡谲的变幻莫测，最畅快的修真探宝，最残忍的杀伐屠戮。\r    幸或不幸，无人能知。但，最丰盛的收获，一定伴随最艰难的探索。你，做好准备了吗？\r    正是：云渺三山射雪光，大荒寂寂覆参商。从来日月经时掩，西岭千秋青女霜。\r    大荒的世界，由此开始。"
			}
MenologyDailyDuplicate['洞天夺宝'] = 
			{ 
				id=639, iconpath1="洞天夺宝.dds", iconpath2="洞天夺宝大.dds",
				name="洞天夺宝" , validtime="分段开启", levelreq="120-160", needreborn=false, permitcount=2, 
				line="1-15线", npc="洞天夺宝", istaskaward=false, taskid="1",
				award=
				{
					{awardid=0, awardiconpath="经验类奖励.dds", awarddesc="^ffcb4a太极金丹\r\r^ffffff获得后自动提升大量修为。"},
...
MenologySystemFunction['法宝血炼'] = 
			{ 
				...
				commendlevel=4, istasknpc=false, descnpc="仙工 妙歌", descmapid=401, descpos="330,486,415", istransport=true, 
...
MenologySystemFunction['阵灵系统'] = 
			{ 
				id=640, iconpath1="阵灵系统.dds", iconpath2="阵灵系统大.dds",  
				name="阵灵系统",validtime="0:00-24:00", levelreq="135-160", needreborn=false, permitcount=-1, 
				line="1-15线", npc="阵灵系统", istaskaward=false, taskid="1",
				award=
				{ 
				...
				desc="^ffffff       打开人物属性界面，点击“阵灵”即可打开^ffcb4a阵法界面^ffffff，只要进行阵灵相关的操作就可以获得更好的阵灵来提升阵法属性。"
			}
MenologySystemFunction['仙裔养成'] = 
			{ 
				id=641, iconpath1="情人节.dds", iconpath2="情人节大.dds",  
				name="仙裔养成",validtime="0:00-24:00", levelreq="15-160", needreborn=true, permitcount=-1, 
				line="1-15线", npc="仙裔养成", istaskaward=false, taskid="1",
				award=
				{ 
				...
				desc="^ffffff       两个互为配偶并已飞升且有职业的角色，组队完成任务“且行且珍惜”获得“莲子”后，前往“凤凰楼”使用“莲子”可分别获得属于自己的“仙裔”。增加悟性和神力等都可以提升仙裔的属性。"
			}
...
MenologyUseItems['使用完璧符'] =
			{ 
				id=542, iconpath1="八极战魂.dds", iconpath2="八极战魂大.dds",  
				name="使用完璧符",validtime="0:00-24:00", levelreq="1-160", needreborn=false, permitcount=-1, 
				line="1-15线", npc="使用完璧符", istaskaward=false, taskid="1",
				award=
				{ 
					{awardid=0, awardiconpath="特殊物品奖励.dds", awarddesc="^ffcb4a活跃度积分\r^ffffff获得该项活跃度积分。"},
				},
...
MenologyUseItems['使用裂影龙剪'] =
			{ 
				id=650, iconpath1="使用外观传承道具.dds", iconpath2="使用外观传承道具大.dds",  
				name="使用裂影龙剪",validtime="0:00-24:00", levelreq="1-160", needreborn=false, permitcount=-1, 
				line="1-15线", npc="使用裂影龙剪", istaskaward=false, taskid="1",
				award=
				{ 
					{awardid=0, awardiconpath="特殊物品奖励.dds", awarddesc="^ffcb4a活跃度积分\r^ffffff获得该项活跃度积分。"},
				},
...
MenologyUseItems['使用冰茧青丝'] =
			{ 
				id=651, iconpath1="使用外观恢复道具.dds", iconpath2="使用外观恢复道具大.dds",  
				name="使用冰茧青丝",validtime="0:00-24:00", levelreq="1-160", needreborn=false, permitcount=-1, 
				line="1-15线", npc="使用冰茧青丝", istaskaward=false, taskid="1",
				award=
				{ 
					{awardid=0, awardiconpath="特殊物品奖励.dds", awarddesc="^ffcb4a活跃度积分\r^ffffff获得该项活跃度积分。"},
				},
...
MenologyUseItems['使用天启'] =
			{ 
				id=652, iconpath1="使用天启.dds", iconpath2="使用天启大.dds",  
				name="使用天启",validtime="0:00-24:00", levelreq="1-160", needreborn=false, permitcount=-1, 
				line="1-15线", npc="使用天启", istaskaward=false, taskid="1",
				award=
				{ 
					{awardid=0, awardiconpath="特殊物品奖励.dds", awarddesc="^ffcb4a活跃度积分\r^ffffff获得该项活跃度积分。"},
				},
				commendlevel=4, istasknpc=false, descnpc="使用天启", descmapid=-1, descpos="9999,0,9999", istransport=false, 
				desc="^ffffff       使用^ffcb4a天启^ffffff恢复外形即可获得该项活跃度积分。（^ffcb4a天启^ffffff可在天帝宝库商城中寻得）"
			}
MenologyUseItems['使用妙谛'] =
			{ 
				id=653, iconpath1="使用妙谛.dds", iconpath2="使用妙谛大.dds",  
				name="使用妙谛",validtime="0:00-24:00", levelreq="1-160", needreborn=false, permitcount=-1, 
				line="1-15线", npc="使用妙谛", istaskaward=false, taskid="1",
				award=
				{ 
					{awardid=0, awardiconpath="特殊物品奖励.dds", awarddesc="^ffcb4a活跃度积分\r^ffffff获得该项活跃度积分。"},
				},
				commendlevel=4, istasknpc=false, descnpc="使用妙谛", descmapid=-1, descpos="9999,0,9999", istransport=false, 
				desc="^ffffff       使用^ffcb4a妙谛^ffffff恢复外形即可获得该项活跃度积分。（^ffcb4a妙谛^ffffff可在天帝宝库商城中寻得）"
			}
MenologyUseItems['使用真言'] =
			{ 
				id=654, iconpath1="使用真言.dds", iconpath2="使用真言大.dds",  
				name="使用真言",validtime="0:00-24:00", levelreq="1-160", needreborn=false, permitcount=-1, 
				line="1-15线", npc="使用真言", istaskaward=false, taskid="1",
				award=
				{ 
					{awardid=0, awardiconpath="特殊物品奖励.dds", awarddesc="^ffcb4a活跃度积分\r^ffffff获得该项活跃度积分。"},
				},
				commendlevel=4, istasknpc=false, descnpc="使用真言", descmapid=-1, descpos="9999,0,9999", istransport=false, 
				desc="^ffffff       使用^ffcb4a真言^ffffff恢复外形即可获得该项活跃度积分。（^ffcb4a真言^ffffff可在天帝宝库商城中寻得）"
			}
MenologyUseItems['使用流言'] =
			{ 
				id=655, iconpath1="使用流言.dds", iconpath2="使用流言大.dds",  
				name="使用流言",validtime="0:00-24:00", levelreq="1-160", needreborn=false, permitcount=-1, 
				line="1-15线", npc="使用流言", istaskaward=false, taskid="1",
				award=
				{ 
					{awardid=0, awardiconpath="特殊物品奖励.dds", awarddesc="^ffcb4a活跃度积分\r^ffffff获得该项活跃度积分。"},
				},
