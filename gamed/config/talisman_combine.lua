...
function ZLuaTalisman_CombineAppendix()
	...
	cidmatrix[10924]={cidwithlvl=0,cidusetype=1,cidloveid=Temp_TalismanIDs["US_135_ShiXueZhu"].tmplID,cidmulti=1,cidcombo=0}	
	cidmatrix[10925]={cidwithlvl=0,cidusetype=1,cidloveid=Temp_TalismanIDs["US_145_ShiHun"].tmplID,cidmulti=1,cidcombo=0}		

	cidmatrix[13798]={cidwithlvl=0,cidusetype=1,cidloveid=Temp_TalismanIDs["GW_135_YouMingGuiShou"].tmplID,cidmulti=1,cidcombo=0}
	cidmatrix[13797]={cidwithlvl=0,cidusetype=1,cidloveid=Temp_TalismanIDs["HH_135_QianKunSuo"].tmplID,cidmulti=1,cidcombo=0}
	cidmatrix[13795]={cidwithlvl=0,cidusetype=1,cidloveid=Temp_TalismanIDs["QY_135_ChiJinLing"].tmplID,cidmulti=1,cidcombo=0}	
	cidmatrix[13796]={cidwithlvl=0,cidusetype=1,cidloveid=Temp_TalismanIDs["TY_135_LunHuiPan"].tmplID,cidmulti=1,cidcombo=0}
...
---如果法宝ID为飞宝，则血炼失败
  ...
  output:CreateItem(-1)
	...
	if (temp_cid[cid].cidloveid~=id1 and temp_cid[cid].cidusetype==1) or 
			(temp_cid[cid].cidwithlvl~=NowAReqLvl and temp_cid[cid].cidusetype==3) then
			if temp_cid[cid].cidwithlvl==75 and NowAReqLvl>=75 then
			else
				iswronginput=1
				output:CreateItem(-1)
			end
