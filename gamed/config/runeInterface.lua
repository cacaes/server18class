...
function RuneInit(id, rune,score)
    ...
    local AttributeLib = 
    			{
   				1400,1600,1000,1000,3000,2800,300000,400000,300,300,
   				30000,300,300,400,400,400,400,400,400,800,
   				100,900,300000,300000,900,900,0,
    			}
    ---属性池2概率分布(每行10个)
    local AttributeLib2 =
    			{
    			1400,1600,1000,1000,3000,2800,300,400000,300,300000,
   				300,300,300,400,400,400,400,400,400,800,
   				100,900,300,300,900,900,0,300000,300,300000,
   				400,300,100,
    ...
    local AttributeGrades =
    			{
    			500,250,120,500,300,200,150,120,90,80,
    			70,40,30,15,10,8,6,4,2,1,
    			}  
    ---生成条目的概率分布（2条到8条）
    local AttributeNumberList =
    			{
    			500,700,600,150,45,400,1000000,
    			--1,1,1,1,1,1,10000,
    			}
