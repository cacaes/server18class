...
function ZLuaPetBedgeCidMatrix()
	...
	local CidMatrix={}
		...
		--- added by comper
		CidMatrix[25125]={type=40,effect1=25124,effect2=0,effect3=0,effect4=0,effect5=0,effect6=0,effect7=0} --Three-eye Monkey Soul
		CidMatrix[25283]={type=40,effect1=24781,effect2=0,effect3=0,effect4=0,effect5=0,effect6=0,effect7=0} --Blossom Princess Soul
		CidMatrix[25391]={type=40,effect1=25311,effect2=0,effect3=0,effect4=0,effect5=0,effect6=0,effect7=0} --MiuMiu Soul
		CidMatrix[25436]={type=40,effect1=25422,effect2=0,effect3=0,effect4=0,effect5=0,effect6=0,effect7=0} --Wolfgang Soul
		CidMatrix[25437]={type=40,effect1=25421,effect2=0,effect3=0,effect4=0,effect5=0,effect6=0,effect7=0} --Little Sheep Soul
		CidMatrix[71542]={type=40,effect1=20108,effect2=0,effect3=0,effect4=0,effect5=0,effect6=0,effect7=0} --Chromawing Soul
		CidMatrix[71543]={type=40,effect1=25117,effect2=0,effect3=0,effect4=0,effect5=0,effect6=0,effect7=0} --Kuzge Soul
		--- added by comper 1715
		CidMatrix[77963]={type=40,effect1=78000,effect2=0,effect3=0,effect4=0,effect5=0,effect6=0,effect7=0} --Dragon Scout Soul
		CidMatrix[77964]={type=40,effect1=78002,effect2=0,effect3=0,effect4=0,effect5=0,effect6=0,effect7=0} --Yaksha Ranger Soul
		CidMatrix[77965]={type=40,effect1=77999,effect2=0,effect3=0,effect4=0,effect5=0,effect6=0,effect7=0} --Madame Chimes Soul
		CidMatrix[77966]={type=40,effect1=78001,effect2=0,effect3=0,effect4=0,effect5=0,effect6=0,effect7=0} --Bliss Parrot Soul
		CidMatrix[77967]={type=40,effect1=78003,effect2=0,effect3=0,effect4=0,effect5=0,effect6=0,effect7=0} --Plump Panda Soul
		CidMatrix[77968]={type=40,effect1=78004,effect2=0,effect3=0,effect4=0,effect5=0,effect6=0,effect7=0} --Genghis Kong Soul
		--- added by wasp
		CidMatrix[71541]={type=40,effect1=23337,effect2=0,effect3=0,effect4=0,effect5=0,effect6=0,effect7=0} --Cloud Tiger Soul
...
function ZLuaPetBedgeSetSpirit(pet_tid,pet_in,pet_out,cid,aid,origin)  
  ...
  local availableChangeModelPets={16503,16504,16505,16506,16507,16508,18306,18929,19510,20108,19110,20488,
  																...
  																25421,41784,25385,33146,29993,29994,29995,29996,29997,30988,30989,30990,30991,34126,34214,34215,
  																34289,40541,40631,40665,40863,40864,40865,40866,40867,40868,40869,40870,41261,41262,41928,
  																42683,62772,63013,63162,63451,67294,77999,78000,78001,78002,78003,78004,71541}
...
function PetBedgeReborn(pet_tid,pet)
	...
	for i = 1,6 do
		if pet:QueryData(DataIndex[Skills[i]]) == 0 then 
			...
			pet:UpdateData(DataIndex[Skilllvls[i]], math.ceil(math.random(1,30)))
			break
		end
	end	
