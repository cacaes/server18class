...
function ZLuaAvailablePets()
	...
	crit=0.01,critdmg=1.1,spirit_id=71543,
	combine_able=1,fixage_able=1,free_able=1,
	...
	crit=0.01,critdmg=1.1,spirit_id=25436,
	combine_able=1,fixage_able=1,free_able=1,
	...
	crit=0.01,critdmg=1.1,spirit_id=25437,
	combine_able=1,fixage_able=1,free_able=1,
...
--]]
	...
	AvailablePets["lingxiaochengQJ"]=
	{pet_tid=70014,race=Race["teshu"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=0,fixage_able=0,free_able=0,
	changefigure_able=0,default_potential=30,born_special=15}	---//凌霄城QJ号宠物特殊)(特定)	
	
	AvailablePets["lingxiaochengYZ"]=
	{pet_tid=70015,race=Race["teshu"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=0,fixage_able=0,free_able=0,
	changefigure_able=0,default_potential=30,born_special=15}	---//凌霄城神裔yz号宠物特殊)(特定)	
	
	AvailablePets["lingxiaochengPJ"]=
	{pet_tid=70016,race=Race["teshu"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=0,fixage_able=0,free_able=0,
	changefigure_able=0,default_potential=30,born_special=15}	---//凌霄城神裔pj号宠物特殊)(特定)	
	
	AvailablePets["lingxiaochengQL"]=
	{pet_tid=70017,race=Race["teshu"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=0,fixage_able=0,free_able=0,
	changefigure_able=0,default_potential=30,born_special=15}	---//凌霄城神裔QL号宠物特殊)(特定)	
  ...
  AvailablePets["20120905shouhushiling1"]=
	...
	AvailablePets["20140913zhuxianxian"]=
	{pet_tid=66710,race=Race["xianling"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}					---//20140913永久诛小仙（仙灵）
	...
	AvailablePets["20131226yunju"]=
	{pet_tid=63013,race=Race["xianling"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}					---//20131226新年宠物云驹（仙灵）

	AvailablePets["20140114chongwumao"]=
	{pet_tid=63162,race=Race["xianling"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}					---//20140114情人节宠物猫（仙灵）

	AvailablePets["20140123xiaoma"]=
	{pet_tid=63224,race=Race["xianling"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}					---//20140123彩虹小马（仙灵）

	AvailablePets["20131123xiaoma18"]=
	{pet_tid=63225,race=Race["xianling"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=0,fixage_able=0,free_able=0,
	changefigure_able=1,default_potential=25,born_special=15}					---//20140123彩虹小马18星（仙灵）

	AvailablePets["20140313huali18"]=
	{pet_tid=63396,race=Race["xianling"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=0,fixage_able=0,free_able=0,
	changefigure_able=1,default_potential=25,born_special=15}					---//20140313花狸18星（仙灵）

	AvailablePets["20140321huayao"]=
	{pet_tid=63451,race=Race["xianling"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}					---//20140321宠物花妖（仙灵）

	AvailablePets["20140428diyu"]=
	{pet_tid=64790,race=Race["xianling"],
	crit=0.05,critdmg=1.5,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}					---//20140428宠物帝羽（仙灵）

	AvailablePets["20140428kuilong"]=
	{pet_tid=64791,race=Race["xianling"],
	crit=0.05,critdmg=1.5,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}					---//20140428宠物夔龙（仙灵）

	AvailablePets["20140428feidan"]=
	{pet_tid=64792,race=Race["xianling"],
	crit=0.05,critdmg=1.5,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}					---//20140428宠物飞诞（仙灵）

	AvailablePets["20140428wahuang"]=
	{pet_tid=64793,race=Race["xianling"],
	crit=0.05,critdmg=1.5,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}					---//20140428宠物娲皇（仙灵）

	AvailablePets["2014xianjielinghou"]=
	{pet_tid=64990,race=Race["xianling"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//2014GT仙界灵猴(仙灵)
	
	AvailablePets["2015yuandan"]=
	{pet_tid=67446,race=Race["xianling"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=0,fixage_able=0,free_able=0,
	changefigure_able=1,default_potential=25,born_special=15}	---//2015vip神仙姐姐青萝18星(仙灵)

	AvailablePets["2015jiangxiaohu"]=
	{pet_tid=67447,race=Race["xianling"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//2015姜小虎(仙灵)
	
	AvailablePets["2015chongwulong"]=
	{pet_tid=67456,race=Race["xianling"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//2015宠物龙(仙灵)
	
	AvailablePets["20141201maotouying"]=
	{pet_tid=67294,race=Race["yeshou"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}					---//20130826永久诛小仙（仙灵）

	AvailablePets["20150110dadaoguai"]=
	{pet_tid=67631,race=Race["yaozu"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}					---//20150210大刀怪（妖族）

	AvailablePets["2015jiangxiaohuplus"]=
	{pet_tid=68842,race=Race["xianling"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//2015绑定姜小虎(仙灵)
	
	AvailablePets["2015crossserverpk"]=
	{pet_tid=70615,race=Race["xianling"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//2015跨服PK
	
	AvailablePets["2016newpet1"]=
	{pet_tid=72058,race=Race["xianling"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper
	
	AvailablePets["2016newpet2"]=
	{pet_tid=72104,race=Race["xianling"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper
	
	AvailablePets["2016newpet3"]=
	{pet_tid=74798,race=Race["xianling"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper
	
	AvailablePets["2016newpet4"]=
	{pet_tid=75051,race=Race["xianling"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper
	
	AvailablePets["2016newpet5"]=
	{pet_tid=75258,race=Race["xianling"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper
	
	AvailablePets["2016newpet6"]=
	{pet_tid=75390,race=Race["xianling"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper
	
	AvailablePets["2017newpet1"]=
	{pet_tid=77652,race=Race["yuansu"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper
	
	AvailablePets["2017newpet2"]=
	{pet_tid=77999,race=Race["yuansu"],
	crit=0.01,critdmg=1.1,spirit_id=77965,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper
	
	AvailablePets["2017newpet3"]=
	{pet_tid=78000,race=Race["yuansu"],
	crit=0.01,critdmg=1.1,spirit_id=77963,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper
	
	AvailablePets["2017newpet4"]=
	{pet_tid=78001,race=Race["yuansu"],
	crit=0.01,critdmg=1.1,spirit_id=77966,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper
	
	AvailablePets["2017newpet5"]=
	{pet_tid=78002,race=Race["yuansu"],
	crit=0.01,critdmg=1.1,spirit_id=77964,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper
	
	AvailablePets["2017newpet6"]=
	{pet_tid=78003,race=Race["yuansu"],
	crit=0.01,critdmg=1.1,spirit_id=77967,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper
	
	AvailablePets["2017newpet7"]=
	{pet_tid=78004,race=Race["yuansu"],
	crit=0.01,critdmg=1.1,spirit_id=77968,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper
	
	AvailablePets["2017newpet8"]=
	{pet_tid=78761,race=Race["yuansu"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper 1736
	
	AvailablePets["2017newpet9"]=
	{pet_tid=78762,race=Race["yuansu"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper 1736
	
	AvailablePets["2017newpet9"]=
	{pet_tid=79505,race=Race["yuansu"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper 1736
	
	AvailablePets["2017newpet10"]=
	{pet_tid=79519,race=Race["yuansu"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper 1736
	
	AvailablePets["2017newpet11"]=
	{pet_tid=80569,race=Race["yuansu"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper 1736
	
	AvailablePets["2017newpet12"]=
	{pet_tid=80939,race=Race["yuansu"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper 1736
	
	AvailablePets["2018newpet1"]=
	{pet_tid=81245,race=Race["yuansu"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper 1792
	
	AvailablePets["2018newpet2"]=
	{pet_tid=81336,race=Race["yuansu"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper 1792
	
	AvailablePets["2018newpet3"]=
	{pet_tid=81522,race=Race["yuansu"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper 1792
	
	AvailablePets["2018newpet4"]=
	{pet_tid=83099,race=Race["yuansu"],
	crit=0.01,critdmg=1.1,spirit_id=0,
	combine_able=1,fixage_able=1,free_able=1,
	changefigure_able=1,default_potential=1,born_special=0}	---//comper 1792
