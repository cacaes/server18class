...
function ZStaticAvailableMonsterList()
	local staticmonster={}
		...
		staticmonster[6]={monster_id=74460,pet_id=40865}	---//猫头鹰
		staticmonster[7]={monster_id=74493,pet_id=74798}	---//猫头鹰
...
function ZStaticRecipeList()
	local staticrecipe={}
		...
		staticrecipe[2407]={recipe_id=6151,recipe_group=0,recipe_level=8,recipe_type=1}   ---[120]寰空铩    
		staticrecipe[2408]={recipe_id=6152,recipe_group=0,recipe_level=9,recipe_type=1}   ---[135]截脉铩    
		staticrecipe[2409]={recipe_id=6153,recipe_group=0,recipe_level=10,recipe_type=1}  ---[148]除命铩    
		staticrecipe[2410]={recipe_id=6168,recipe_group=0,recipe_level=8,recipe_type=3}   ---[120]灵鹤冠[男]
		staticrecipe[2411]={recipe_id=6169,recipe_group=0,recipe_level=8,recipe_type=3}   ---[120]灵鹤冠[女]
		staticrecipe[2412]={recipe_id=6170,recipe_group=0,recipe_level=9,recipe_type=3}   ---[135]天浪冠[男]
		staticrecipe[2413]={recipe_id=6171,recipe_group=0,recipe_level=9,recipe_type=3}   ---[135]天浪冠[女]
		staticrecipe[2414]={recipe_id=6172,recipe_group=0,recipe_level=10,recipe_type=3}  ---[142]天心冠[男]
		staticrecipe[2415]={recipe_id=6173,recipe_group=0,recipe_level=10,recipe_type=3}  ---[142]天心冠[女]
		staticrecipe[2416]={recipe_id=6188,recipe_group=0,recipe_level=8,recipe_type=2}   ---[120]灵鹤袍[男]
		staticrecipe[2417]={recipe_id=6189,recipe_group=0,recipe_level=8,recipe_type=2}   ---[120]灵鹤袍[女]
		staticrecipe[2418]={recipe_id=6190,recipe_group=0,recipe_level=9,recipe_type=2}   ---[135]天浪袍[男]
		staticrecipe[2419]={recipe_id=6191,recipe_group=0,recipe_level=9,recipe_type=2}   ---[135]天浪袍[女]
		staticrecipe[2420]={recipe_id=6192,recipe_group=0,recipe_level=10,recipe_type=2}  ---[146]天心袍[男]
		staticrecipe[2421]={recipe_id=6193,recipe_group=0,recipe_level=10,recipe_type=2}  ---[146]天心袍[女]
		staticrecipe[2422]={recipe_id=6208,recipe_group=0,recipe_level=8,recipe_type=4}   ---[120]灵鹤靴[男]
		staticrecipe[2423]={recipe_id=6209,recipe_group=0,recipe_level=8,recipe_type=4}   ---[120]灵鹤靴[女]
		staticrecipe[2424]={recipe_id=6210,recipe_group=0,recipe_level=9,recipe_type=4}   ---[135]天浪靴[男]
		staticrecipe[2425]={recipe_id=6211,recipe_group=0,recipe_level=9,recipe_type=4}   ---[135]天浪靴[女]
		staticrecipe[2426]={recipe_id=6212,recipe_group=0,recipe_level=10,recipe_type=4}  ---[144]天心靴[男]
		staticrecipe[2427]={recipe_id=6213,recipe_group=0,recipe_level=10,recipe_type=4}  ---[144]天心靴[女]
		staticrecipe[2428]={recipe_id=6214,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_紫微配方      
		staticrecipe[2429]={recipe_id=6215,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_武曲配方      
		staticrecipe[2430]={recipe_id=6216,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_天机配方      
		staticrecipe[2431]={recipe_id=6217,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_贪狼配方      
		staticrecipe[2432]={recipe_id=6218,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_太阳配方      
		staticrecipe[2433]={recipe_id=6219,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_天同配方      
		staticrecipe[2434]={recipe_id=6220,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_廉贞配方      
		staticrecipe[2435]={recipe_id=6221,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_天府配方      
		staticrecipe[2436]={recipe_id=6222,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_巨门配方      
		staticrecipe[2437]={recipe_id=6223,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_太阴配方      
		staticrecipe[2438]={recipe_id=6224,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_天相配方      
		staticrecipe[2439]={recipe_id=6225,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_天梁配方      
		staticrecipe[2440]={recipe_id=6226,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_七杀配方      
		staticrecipe[2441]={recipe_id=6227,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_左辅配方      
		staticrecipe[2442]={recipe_id=6228,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_右弼配方      
		staticrecipe[2443]={recipe_id=6229,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_天魁配方      
		staticrecipe[2444]={recipe_id=6230,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_天钺配方      
		staticrecipe[2445]={recipe_id=6231,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_文昌配方      
		staticrecipe[2446]={recipe_id=6232,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_文曲配方      
		staticrecipe[2447]={recipe_id=6233,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_天马配方      
		staticrecipe[2448]={recipe_id=6234,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_禄存配方      
		staticrecipe[2449]={recipe_id=6235,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_铃星配方      
		staticrecipe[2450]={recipe_id=6236,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_火星配方      
		staticrecipe[2451]={recipe_id=6237,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_地空配方      
		staticrecipe[2452]={recipe_id=6238,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_地劫配方      
		staticrecipe[2453]={recipe_id=6239,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_擎羊配方      
		staticrecipe[2454]={recipe_id=6240,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_陀罗配方      
		staticrecipe[2455]={recipe_id=6241,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_龙池配方      
		staticrecipe[2456]={recipe_id=6242,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_凤阁配方      
		staticrecipe[2457]={recipe_id=6243,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_红鸾配方      
		staticrecipe[2458]={recipe_id=6244,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_天喜配方      
		staticrecipe[2459]={recipe_id=6245,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_孤辰配方      
		staticrecipe[2460]={recipe_id=6246,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_寡宿配方      
		staticrecipe[2461]={recipe_id=6247,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_蜚廉配方      
		staticrecipe[2462]={recipe_id=6248,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_破碎配方      
		staticrecipe[2463]={recipe_id=6249,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_华盖配方      
		staticrecipe[2464]={recipe_id=6250,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_天虚配方      
		staticrecipe[2465]={recipe_id=6251,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_天刑配方      
		staticrecipe[2466]={recipe_id=6252,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_三台配方      
		staticrecipe[2467]={recipe_id=6253,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_八座配方      
		staticrecipe[2468]={recipe_id=6254,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_恩光配方      
		staticrecipe[2469]={recipe_id=6255,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_天贵配方      
		staticrecipe[2470]={recipe_id=6256,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_虚空配方      
		staticrecipe[2471]={recipe_id=6257,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_天巫配方      
		staticrecipe[2472]={recipe_id=6258,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_天月配方      
		staticrecipe[2473]={recipe_id=6259,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_阴煞配方      
		staticrecipe[2474]={recipe_id=6260,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_咸池配方      
		staticrecipe[2475]={recipe_id=6261,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_大耗配方      
		staticrecipe[2476]={recipe_id=6262,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_截空配方      
		staticrecipe[2477]={recipe_id=6263,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_龙德配方      
		staticrecipe[2478]={recipe_id=6264,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军_天姚配方      
		staticrecipe[2479]={recipe_id=6265,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军2_贪狼_巨门配方
		staticrecipe[2480]={recipe_id=6266,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军2_天相_天钺配方
		staticrecipe[2481]={recipe_id=6267,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军2_天马_龙池配方
		staticrecipe[2482]={recipe_id=6268,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军2_地空_天喜配方
		staticrecipe[2483]={recipe_id=6269,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军2_天虚_恩光配方
		staticrecipe[2484]={recipe_id=6270,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军2_八座_阴煞配方
		staticrecipe[2485]={recipe_id=6271,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军2_天贵_龙德配方
		staticrecipe[2486]={recipe_id=6272,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军2_擎羊_红鸾配方
		staticrecipe[2487]={recipe_id=6273,recipe_group=0,recipe_level=1,recipe_type=5}   ---护符_破军2_天月_截空配方
		staticrecipe[2488]={recipe_id=6402,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)彩云归配方
		staticrecipe[2489]={recipe_id=6388,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)残宣诀配方
		staticrecipe[2490]={recipe_id=6385,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)春莺转配方
		staticrecipe[2491]={recipe_id=6379,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)点绛唇配方
		staticrecipe[2492]={recipe_id=6367,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)风归云配方
		staticrecipe[2493]={recipe_id=6405,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)凤仙引配方
		staticrecipe[2494]={recipe_id=6360,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)广寒枝配方
		staticrecipe[2495]={recipe_id=6387,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)回波词配方
		staticrecipe[2496]={recipe_id=6386,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)混罗衣配方
		staticrecipe[2497]={recipe_id=6384,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)将进酒配方
		staticrecipe[2498]={recipe_id=6407,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)解火令配方												
		staticrecipe[2499]={recipe_id=6383,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)控春令配方
		staticrecipe[2500]={recipe_id=6409,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)临晚镜配方	
		staticrecipe[2501]={recipe_id=6378,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)柳含烟配方		
		staticrecipe[2502]={recipe_id=6393,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)楼上曲配方
		staticrecipe[2503]={recipe_id=6365,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)落华英配方		
		staticrecipe[2504]={recipe_id=6375,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)满堂彩配方		
		staticrecipe[2505]={recipe_id=6376,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)眉峰碧配方		
		staticrecipe[2506]={recipe_id=6364,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)梦行云配方
		staticrecipe[2507]={recipe_id=6368,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)穆护砂配方
		staticrecipe[2508]={recipe_id=6391,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)菩萨蛮配方
		staticrecipe[2509]={recipe_id=6382,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)青门引配方
		staticrecipe[2510]={recipe_id=6362,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)清波引配方
		staticrecipe[2511]={recipe_id=6366,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)清商怨配方
		staticrecipe[2512]={recipe_id=6395,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)晴偏好配方
		staticrecipe[2513]={recipe_id=6390,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)秋宵吟配方
		staticrecipe[2514]={recipe_id=6381,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)绕地游配方
		staticrecipe[2515]={recipe_id=6371,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)瑞龙吟配方
		staticrecipe[2516]={recipe_id=6396,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)散余霞配方
		staticrecipe[2517]={recipe_id=6397,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)伤流景配方
		staticrecipe[2518]={recipe_id=6377,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)升平乐配方
		staticrecipe[2519]={recipe_id=6404,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)苏幕遮配方
		staticrecipe[2520]={recipe_id=6372,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)太平令配方
		staticrecipe[2521]={recipe_id=6392,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)唐多令配方
		staticrecipe[2522]={recipe_id=6374,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)晚云高配方
		staticrecipe[2523]={recipe_id=6369,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)乌夜啼配方
		staticrecipe[2524]={recipe_id=6406,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)夏初临配方
		staticrecipe[2525]={recipe_id=6359,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)相见欢配方
		staticrecipe[2526]={recipe_id=6363,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)眼儿媚配方
		staticrecipe[2527]={recipe_id=6380,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)燕归梁配方
		staticrecipe[2528]={recipe_id=6400,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)阳关曲配方
		staticrecipe[2529]={recipe_id=6373,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)应天长配方
		staticrecipe[2530]={recipe_id=6361,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)玉阑干配方
		staticrecipe[2531]={recipe_id=6399,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)御街行配方
		staticrecipe[2532]={recipe_id=6403,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)元和令配方
		staticrecipe[2533]={recipe_id=6370,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)越溪寒配方
		staticrecipe[2534]={recipe_id=6398,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)长生乐配方	
		staticrecipe[2535]={recipe_id=6389,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)长亭晚配方	
		staticrecipe[2536]={recipe_id=6394,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)掷金杯配方
		staticrecipe[2537]={recipe_id=6408,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)驻云飞配方
		staticrecipe[2538]={recipe_id=6401,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)醉蓬莱配方
		staticrecipe[2539]={recipe_id=6410,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)<广寒枝><玉阑干>配方
		staticrecipe[2540]={recipe_id=6418,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)<混罗衣><乌夜啼>配方
		staticrecipe[2541]={recipe_id=6414,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)<解火令><将进酒>配方
		staticrecipe[2542]={recipe_id=6415,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)<落华英><回波词>配方
		staticrecipe[2543]={recipe_id=6417,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)<满堂彩><散余霞>配方
		staticrecipe[2544]={recipe_id=6413,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)<菩萨蛮><苏幕遮>配方
		staticrecipe[2545]={recipe_id=6412,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)<升平乐><梦行云>配方
		staticrecipe[2546]={recipe_id=6416,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)<太平令><唐多令>配方
		staticrecipe[2547]={recipe_id=6411,recipe_group=0,recipe_level=1,recipe_type=5}   ---(青罗符文)<眼儿媚><醉蓬莱>配方 
		staticrecipe[2555]={recipe_id=6291,recipe_group=0,recipe_level=8,recipe_type=1}   ---[120]仄影扇   
		staticrecipe[2556]={recipe_id=6292,recipe_group=0,recipe_level=9,recipe_type=1}   ---[135]空冥扇   
		staticrecipe[2557]={recipe_id=6293,recipe_group=0,recipe_level=10,recipe_type=1}  ---[148]沧衍扇	
		staticrecipe[2565]={recipe_id=6344,recipe_group=0,recipe_level=8,recipe_type=3}   
		staticrecipe[2566]={recipe_id=6345,recipe_group=0,recipe_level=9,recipe_type=3}
		staticrecipe[2567]={recipe_id=6346,recipe_group=0,recipe_level=10,recipe_type=3}
		staticrecipe[2575]={recipe_id=6354,recipe_group=0,recipe_level=8,recipe_type=3}
		staticrecipe[2576]={recipe_id=6355,recipe_group=0,recipe_level=9,recipe_type=3}
		staticrecipe[2577]={recipe_id=6356,recipe_group=0,recipe_level=10,recipe_type=3}  ---[148]青罗帽子  hat 
		staticrecipe[2585]={recipe_id=6323,recipe_group=0,recipe_level=8,recipe_type=2}   
		staticrecipe[2586]={recipe_id=6324,recipe_group=0,recipe_level=9,recipe_type=2}
		staticrecipe[2587]={recipe_id=6325,recipe_group=0,recipe_level=10,recipe_type=2}
		staticrecipe[2595]={recipe_id=6333,recipe_group=0,recipe_level=8,recipe_type=2}
		staticrecipe[2596]={recipe_id=6334,recipe_group=0,recipe_level=9,recipe_type=2}
		staticrecipe[2597]={recipe_id=6335,recipe_group=0,recipe_level=10,recipe_type=2}  ---[148]青罗衣服    robe
		staticrecipe[2605]={recipe_id=6306,recipe_group=0,recipe_level=8,recipe_type=4}
		staticrecipe[2606]={recipe_id=6307,recipe_group=0,recipe_level=9,recipe_type=4}
		staticrecipe[2607]={recipe_id=6308,recipe_group=0,recipe_level=10,recipe_type=4}
		staticrecipe[2615]={recipe_id=6312,recipe_group=0,recipe_level=8,recipe_type=4}
		staticrecipe[2616]={recipe_id=6313,recipe_group=0,recipe_level=9,recipe_type=4}
		staticrecipe[2617]={recipe_id=6314,recipe_group=0,recipe_level=10,recipe_type=4}  ---[148]青罗鞋子  boots
		staticrecipe[2618]={recipe_id=6554,recipe_group=0,recipe_level=8,recipe_type=1}   ---[120]gevrin weapon  
		staticrecipe[2619]={recipe_id=6555,recipe_group=0,recipe_level=9,recipe_type=1}   ---[135]gevrin weapon   
		staticrecipe[2620]={recipe_id=6556,recipe_group=0,recipe_level=10,recipe_type=1}  ---[148]gevrin weapon	
		staticrecipe[2621]={recipe_id=6617,recipe_group=0,recipe_level=8,recipe_type=3}   
		staticrecipe[2622]={recipe_id=6618,recipe_group=0,recipe_level=9,recipe_type=3}
		staticrecipe[2623]={recipe_id=6619,recipe_group=0,recipe_level=10,recipe_type=3}
		staticrecipe[2624]={recipe_id=6607,recipe_group=0,recipe_level=8,recipe_type=3}
		staticrecipe[2625]={recipe_id=6608,recipe_group=0,recipe_level=9,recipe_type=3}
		staticrecipe[2626]={recipe_id=6609,recipe_group=0,recipe_level=10,recipe_type=3}  ---[148]gevrin  hat 
		staticrecipe[2627]={recipe_id=6596,recipe_group=0,recipe_level=8,recipe_type=2}   
		staticrecipe[2628]={recipe_id=6597,recipe_group=0,recipe_level=9,recipe_type=2}
		staticrecipe[2629]={recipe_id=6598,recipe_group=0,recipe_level=10,recipe_type=2}
		staticrecipe[2630]={recipe_id=6586,recipe_group=0,recipe_level=8,recipe_type=2}
		staticrecipe[2631]={recipe_id=6587,recipe_group=0,recipe_level=9,recipe_type=2}
		staticrecipe[2632]={recipe_id=6588,recipe_group=0,recipe_level=10,recipe_type=2}  ---[148]gevrin  robe
		staticrecipe[2633]={recipe_id=6575,recipe_group=0,recipe_level=8,recipe_type=4}
		staticrecipe[2634]={recipe_id=6576,recipe_group=0,recipe_level=9,recipe_type=4}
		staticrecipe[2635]={recipe_id=6577,recipe_group=0,recipe_level=10,recipe_type=4}
		staticrecipe[2636]={recipe_id=6564,recipe_group=0,recipe_level=8,recipe_type=4}
		staticrecipe[2637]={recipe_id=6566,recipe_group=0,recipe_level=9,recipe_type=4}
		staticrecipe[2638]={recipe_id=6567,recipe_group=0,recipe_level=10,recipe_type=4}  ---[148]gevrin  boots
		staticrecipe[2639]={recipe_id=6708,recipe_group=0,recipe_level=8,recipe_type=1}   ---[120]sylia weapon  
		staticrecipe[2640]={recipe_id=6709,recipe_group=0,recipe_level=9,recipe_type=1}   ---[135]sylia weapon   
		staticrecipe[2641]={recipe_id=6710,recipe_group=0,recipe_level=10,recipe_type=1}  ---[148]sylia weapon	
		staticrecipe[2642]={recipe_id=6768,recipe_group=0,recipe_level=8,recipe_type=3}   
		staticrecipe[2643]={recipe_id=6770,recipe_group=0,recipe_level=9,recipe_type=3}
		staticrecipe[2644]={recipe_id=6772,recipe_group=0,recipe_level=10,recipe_type=3}
		staticrecipe[2645]={recipe_id=6769,recipe_group=0,recipe_level=8,recipe_type=3}
		staticrecipe[2646]={recipe_id=6771,recipe_group=0,recipe_level=9,recipe_type=3}
		staticrecipe[2647]={recipe_id=6773,recipe_group=0,recipe_level=10,recipe_type=3}  ---[148]sylia  hat 
		staticrecipe[2648]={recipe_id=6747,recipe_group=0,recipe_level=8,recipe_type=2}   
		staticrecipe[2649]={recipe_id=6749,recipe_group=0,recipe_level=9,recipe_type=2}
		staticrecipe[2650]={recipe_id=6751,recipe_group=0,recipe_level=10,recipe_type=2}
		staticrecipe[2651]={recipe_id=6748,recipe_group=0,recipe_level=8,recipe_type=2}
		staticrecipe[2652]={recipe_id=6750,recipe_group=0,recipe_level=9,recipe_type=2}
		staticrecipe[2653]={recipe_id=6752,recipe_group=0,recipe_level=10,recipe_type=2}  ---[148]sylia  robe
		staticrecipe[2654]={recipe_id=6726,recipe_group=0,recipe_level=8,recipe_type=4}
		staticrecipe[2655]={recipe_id=6728,recipe_group=0,recipe_level=9,recipe_type=4}
		staticrecipe[2656]={recipe_id=6730,recipe_group=0,recipe_level=10,recipe_type=4}
		staticrecipe[2657]={recipe_id=6727,recipe_group=0,recipe_level=8,recipe_type=4}
		staticrecipe[2658]={recipe_id=6729,recipe_group=0,recipe_level=9,recipe_type=4}
		staticrecipe[2659]={recipe_id=6731,recipe_group=0,recipe_level=10,recipe_type=4}  ---[148]sylia  boots
...
function PetBedgeCatch(monster_id, monster_level, monster_raceinfo, monster_catchdifficulty,monster_hp,player_level, player)
	...
	---//怪物级别不正确
	if type(monster_level)~="number" or monster_level<1 or monster_level>200 then
	...
	---//玩家级别传递错误
	if type(player_level)~="number" or player_level<=0 or player_level>200 then
...
function ExtGainOfCreate(recipe_id, player_level, player_gender, player_prof, player)
	...
	if type(recipe_id)~="number" or type(player_level)~="number" or player_level<0 or player_level>170 then
