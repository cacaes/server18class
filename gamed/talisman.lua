...
--快速血炼
function Talisman_Quick_Combine_Entrance( id, ess, cid, oess, combinevalue)
	local it= {};
	local output= {};
	Talisman_Entrance_Init( id, nil, ess, it );
	Talisman_Entrance_Init( 0, nil, oess ,output );
	...
	output.CreateItem = Talisman_Output_CreateItem;
	ZLuaTalismanSimpleCombine( id,  it, output, cid);
	return output.__ID, output.__talisman_value;
end


--转向性
function Talisman_Turn_Direction_Entrance( id, ess, cid, oess, direction)
	local it= {};
	local output= {};
	Talisman_Entrance_Init( id, nil, ess, it );
	Talisman_Entrance_Init( 0, nil, oess ,output );
	...
	output.CreateItem = Talisman_Output_CreateItem;
	ZLuaTalismanSimpleTurnDirection(id,it,cid,output,direction)
	return output.__ID;
end
